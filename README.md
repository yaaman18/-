# -
人類は貨幣経済によるから離脱して、機械によって自動化された契約の中で生きる事ができるのか?
...
<br>
<br>
その時はイラク戦争の最中で、私が入国したその日にバグダットが陥落してホテルに警官が乗り込んできてテレビをつけてフセイン像が引き倒されているのを見せられました。
<br>
...
<br>
こう言った社会においては実質的な公定価格が存在しなく、法定通貨は無形の信用取引の補助通貨にしかならない時もあります。
<br>
<br>
...
<br>
戦争も国家という部族間の積み重なった、なおかつ決定的な信用の毀損を精算する為に行う経済活動と言う側面もあります。
<br>
そこでの双方の支払額は膨大なものになります。
<br>
<br>
そのあまりにも巨大なコミニュケーションコストを支払った末にどの様な契約が結ばれるかは分かりません。
<br>
それらの問題を解決するためにテクノロジーを用いた新しい経済が構築される必要があると私は考えています。
<br>
それは『歴史上やコミニュティ間のにあった信用を構築する為の莫大なコミニュケーションコストを一気に削減できるのではないか』と見ています。
<br>
<br>
現状では暗号技術やブロックチェーンを用いた技術は決済のための台帳の役割しか果たしていません。
<br>
しかし金融の決済や取引所での契約だけではなく、現実の世界の契約や決済、例えば土地の売買や刑法上及び民法上の判決、更には戦時下での支援やボランティア活動などの金銭的に計算出来ない行為に対しても、プログラミングされた内容に従って決済や執行が出来るのではないでしょうか？
<br>
<br>
重要な点はそれが前述したように、必ずしも法定通貨や暗号資産を媒介して支払われるのではなく、プログラムが構築する巨大な信用取引の域内で直接生活物資や各種サービスを享受出来るシステムを作る事ができると言う事です。
<br>
メリットとしてはこれまで延々と述べて来た様な信用創造や取引、契約、決済にかかるコストが一気に消滅します。
<br>
法定通貨を評価し取引市場を運営する事。硬貨や紙幣でを発行しそれを流通させて支払う及び再び国家が回収する事。見積書や契約書を作成しその約定を遵守させる為に数多くの法律を策定する事。
<br>
...
<br>
<br>
それらの活動の評価値はデータベースに記録している数値と言う事になりますが、通貨による支払いという前提が消滅しているのでそれを数字として表現する必要もなくなります。その場合はどの様な表現をするべきかを論じる必要がありますが。
<br>
<br>
...
<br>
現状のコンピューターに記述出来る計算量もストレージも微々たるものなので、まだそれらのシステムを実現することはできません。
<br>
<br>
また、プログラムが執行する有形無形の契約や法的判断は一体誰がどの様に決めるのかと言う問題もあります。
<br>
...
<br>
<br>
更には分散化された経済の中で、どの様に巨大なプロジェクトを実行する為の資本を集めるのか？と言う問題もあります。
<br>
...
<br>
現行の民主主義や帝国主義でさえ、果たして私達の意志が反映されているのか疑問なのに、人間の無意識の欲求から汲み出されたデータや何者かが構造化したかさえ定かでは無いAIに（例えその判断が人間による物より遥かに妥当であったとしても）従うことができるのでしょうか？
<br>
<br>
...
<br>
<br>
これまでの人類は想像出来るものは物理法則お範疇ではほとんど全て実現して来ました。
<br>
そうであるならば、これまで書いて来たコンピューターが管理する世界と言うのも技術的にが実現不可能ではありません。
<br>
